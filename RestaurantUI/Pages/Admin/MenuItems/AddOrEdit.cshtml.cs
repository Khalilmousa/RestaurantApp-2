...
namespace RestaurantUI.Pages.Admin.MenuItems
{
    public class AddOrEditModel : PageModel
    {
        ...
        public async Task OnGet(int? id)
        {
            if (id != null)
            {
                MenuItem mItem = await _unitOfWork.MenuItemRepo.GetById(id);
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            {
                MenuItem mItemToUpdate = await _unitOfWork.MenuItemRepo.GetById(MenuItem.Id);
        ...
        public async Task<IActionResult> OnGetDelete(int? id)
        {
            if (id != null)
            {
                var mItem = await _unitOfWork.MenuItemRepo.GetById(id);
